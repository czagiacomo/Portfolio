          ...
          <article>
            ...
            <section>
              ...
              <p className='text-lg leading-7 mb-4'>
                Nesse projeto, durante o Generation Brasil, atuei como PO, organizando e acompanhando tarefas.
                Também garanti a qualidade do projeto, documentação e configuração de ambientes e repositórios para os desenvolvedores utilizarem. 
              </p>
              <h2
                id='detalhes'
              ...
              <p className='text-lg leading-7 mb-4'>
                ...
                >
                  ...
                  Este projeto apresenta uma gestão de clientes através de uma API CRUD com cadastro de usuários, tratamentos de erros e persistencia de dados
                  A UI é apresentada de forma limpa e direta, em um formato padrão e conhecido para diversos sites de negócios. 
                <br></br>
                <br></br>
              ...
              <p className='text-lg leading-7 mb-4'>
                ...
                minhas redes sociais, e acesse o link para o CRM para testa-lo!
                <br></br>
                <div className='mx-2 w-1/3'>
                  <a href='https://gestaogen.netlify.app' target='_blank'>
